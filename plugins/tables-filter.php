...
class AdminerTablesFilter
{
	...
	{ ?>
<input id="filter-field" class="form-control" autocomplete="off" placeholder="Filtrer les tables" style="width: 100%; box-sizing: border-box;">
<style type="text/css">#tables li.hidden { display: none; }</style>
